...
const Indonesia = () => {
    ...
    const API_URL = `https://api.nytimes.com/svc/search/v2/articlesearch.json?q=indonesia&api-key=${API_KEY}`;
    ...
    useEffect(() => {
        const fetchStories = async () => {
            try {
                ...
                const transformedStories = data.response.docs.map((article, index) => ({
                    id: `story_${index}`, 
                ...
                console.error('Error fetching Indonesia stories:', error);
                setLoading(false);
            }
        };
    ...
    return (
        <div className="container mt-0 pt-0">
            <h2 className="text-center mb-2 fw-bold">Indonesia News</h2>
                    ...
                    <div key={story.id} className="col-md-4 mb-4">
                        <div className="card h-100">
                            {story.multimedia.length > 0 ? (
                                <img
                                    src={`https://www.nytimes.com/${story.multimedia[0].url}`}
                                    alt={story.title}
